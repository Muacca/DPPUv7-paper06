...
\input{sections/sec02}   % Lorentzian-native setup and topology conventions
\input{sections/sec03}   % Hamiltonian admissibility by topology
\input{sections/sec04}   % P-channel dictionary and topology response
\input{sections/sec05}   % chi-universality across diagnostic and reduced-orbit levels
\input{sections/sec06}   % Four-topology admissibility classification
\input{sections/sec07}   % Reduced orbit atlas and chi-sign separation
\input{sections/sec08}   % Discussion
...
%------------------------------------------------------------------------------
\appendix
\input{appendices/appA}  % Topology conventions, local reductions, and caveats
\input{appendices/appB}  % Tables, computational checks, and reproducibility notes
\input{appendices/appC}  % Bianchi I lite comparison and reduced-atlas scope guard
